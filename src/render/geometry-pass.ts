...
import { DepthPassResources } from "./depth-pass";
...
export interface geometryPassResources {
...
export async function initDepthPass(
    ...
    // create depth map data type to return
    depthMap = createDepthMap(gpu, depthPassSize, numOfCascades);
...
var depthMap: depthMap | undefined;
